...
function ShortActions() {
  return (
    <div className="flex flex-col justify-end px-3 text-[14px] tablet:static absolute bottom-5 right-0">
      <div className="pb-4">
        <div className="tablet:bg-[#272727] bg-[#ffffff1a] flex justify-center items-center p-3 rounded-full">
      ...
      <div>
        <img
          className="h-10 w-10 rounded-md border-white border-[2px]"
...
const Shorts = () => {
  ...
  return (
    <>
      {[1, 2, 3, 4].map(() => (
        <>
          <div className="relative mt-16 overflow-hidden tablet:ml-20 ml-0 flex justify-center tablet:static">
            <div className="relative h-5/6 w-[356px]">
              <img
                src={imgLink}
                className="h-5/6 w-[356px] mobile:rounded-xl"
                alt="thumb-nail-image"
              />
              <div className="absolute bottom-5 w-full">
                <div className="ml-[15px] mb-2">World's largest Community</div>
                <div className="flex justify-start tablet:justify-between items-center mx-[15px]">
                  ...
                  <div>
                    <span className="bg-[#fff] text-[#212121] text-[14px] font-bold py-[10px] px-4 line-h rounded-full ml-2">
                      Subscribe
                    </span>
                  </div>
                </div>
              ...
              <div className="flex tablet:hidden">
                <ShortActions className="block tablet:hidden" />
              </div>
              <div onClick={() => navigate("/")} className="block mobile:hidden absolute top-3 left-3">
                <ArrowBackIcon />
              </div>
            </div>
