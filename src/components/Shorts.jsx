    ...
    <div className="mt-16 overflow-hidden tablet:ml-20 ml-0 flex justify-center">
      <div className="relative h-5/6 w-[356px]">
        ...
        <div className="absolute bottom-5 w-full">
          <div className="ml-[15px] mb-2">Fastest Human Calculator #358</div>
          <div className="flex justify-between items-center mx-[15px]">
            <div className="flex items-center">
              ...
              <div className="pl-[6px] font-semibold text-sm">@NasDaily</div>
            </div>
            <div>
      ...
      <div className="hidden tablet:flex flex-col justify-end px-3 text-[14px]">
        ...
        <div>
            <img className="h-10 w-10 rounded-md" src="https://yt3.ggpht.com/ytc/AOPolaRTPMRdc7uXb2SV6JmRhr39ccuqDrcRAKB22aPClQ=s88-c-k-c0x00ffffff-no-rj" alt="" />
        </div>
      </div>
    </div>
  );
