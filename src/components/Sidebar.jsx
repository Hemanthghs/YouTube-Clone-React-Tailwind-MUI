...
export function Options() {
  ...
  return (
    <>
      <Box
        className="hover: cursor-pointer hover:bg-[#222222] h-[48px] tablet:h-[74px] w-16 rounded-[10px]"
        sx={{
          display: "flex",
        ...
        onClick={() => handleClick("/")}
      >
        <Box className="tablet:mb-[6px]">
          <div onClick={() => handleClick("/")} className="fill-white">
      ...
      >
        <Box className="tablet:mb-[6px]">
          <div onClick={() => handleClick("/shorts")} className="fill-white">
            <svg height="24" viewBox="0 0 24 24" width="24" focusable="false">
